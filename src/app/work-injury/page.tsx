...
import * as content from "@content/content/pages/work-injury-hub";
...
const medicalSpecialtySchema = {
  ...
  name: "Workers' Compensation & Work Injury Care",
  alternateName: "Occupational Medicine",
  description: content.seo.description,
...
export default function WorkInjuryHubPage() {
  return (
    <>
      <Breadcrumb
        items={[
      ...
      <section className="py-[100px] px-[5vw] bg-off-white">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <SectionLabel text="Work Injury Hub" className="mb-6" />
            <h2
          ...
          {content.intro.secondaryImage && (
            <div className="relative h-[400px] overflow-hidden hidden lg:block">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, transparent 60%, rgba(244,183,106,0.18) 100%)",
                }}
                aria-hidden="true"
              />
            </div>

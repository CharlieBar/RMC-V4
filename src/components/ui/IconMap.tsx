...
function Bone({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M17 10c.7-.7 1.69 0 2.5 0a2.5 2.5 0 1 0 0-5 1 1 0 0 1-1-1 2.5 2.5 0 1 0-5 0c0 .81.7 1.8 0 2.5l-7 7c-.7.7-1.69 0-2.5 0a2.5 2.5 0 0 0 0 5 1 1 0 0 1 1 1 2.5 2.5 0 0 0 5 0c0-.81-.7-1.8 0-2.5Z" />
    </svg>
  );
}

function Nerve({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <path d="M6 6c0 3.31 2.69 6 6 6s6-2.69 6-6" />
      <path d="M6 18c0-3.31 2.69-6 6-6s6 2.69 6 6" />
    </svg>
  );
}

function Muscle({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
      ...
      aria-hidden="true"
    >
      <path d="M6.5 6.5c3.5 0 6 2 8 4s4 3.5 4 6c0 2-1 3-3 3s-3-1-3-3" />
      <path d="M3 12c0-4 2.5-7 7-7 2.5 0 4.5 1.5 6 4" />
    </svg>
  );
}

function Syringe({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
function Bandage({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <path d="M10 14.01V14" />
      <path d="M14 10.01V10" />
      <path d="M18.347 7.653a4.5 4.5 0 0 1 0 6.364L14.5 17.864l-8.153-8.153 3.847-3.847a4.5 4.5 0 0 1 6.153 1.789z" />
      <path d="m2 22 5.793-5.793" />
      <path d="m5.5 18.5 1-1" />
    </svg>
  );
}

function HardHat({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
...
function Car({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M19 17H5v-5L7 7h10l2 5v5z" />
...
function Microscope({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path d="M6 18h8" />
      <path d="M3 21h18" />
      <path d="M14 21v-4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v4" />
      <path d="M14 7v4" />
      <path d="M10 11V7" />
...
function XRay({ className }: IconProps) {
  return (
    <svg
      width="24"
      height="24"

// src/content/conditions/muscle/muscle-spasms.ts
// Rand Medical Center — Muscle Spasms (Condition Page)
...
export const seo: SEOMeta = {
  title: "Muscle Spasms Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Muscle Spasms treatment in Arlington Heights, IL. Sudden, painful muscle tightening that can limit movement and cause sharp pain. Call (224) 735-3522.",
  keywords: ["muscle spasms treatment Arlington Heights", "muscle spasms doctor near me", "muscle spasms specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/muscle/muscle-spasms",
};

export const hero: HeroSection = {
  eyebrow: "Muscle Conditions",
  headline: "Muscle Spasms Treatment in Arlington Heights, IL",
  subheadline: "Sudden, painful muscle tightening that can limit movement and cause sharp pain.",
...
export const definition = {
  headline: "What Is Muscle Spasms?",
  body: "Sudden, painful muscle tightening that can limit movement and cause sharp pain. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Sudden involuntary muscle contraction" },
    { text: "Sharp, intense pain" },
    { text: "Visible or palpable muscle tightness" },
    { text: "Difficulty moving the affected area" },
    { text: "Pain lasting seconds to minutes" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    { text: "Muscle fatigue or overuse" },
    { text: "Dehydration or electrolyte imbalance" },
    { text: "Nerve irritation" },
    { text: "Injury to the muscle or spine" },
...
export const howWeHelp = {
  headline: "Muscle Spasms Treatment at Rand Medical Center",
...
export const ctaSection = {
  headline: "Get Help for Muscle Spasms in Arlington Heights",
  body: "Don't let muscle spasms hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

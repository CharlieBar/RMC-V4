// src/content/conditions/joints/foot-ankle-pain.ts
// Rand Medical Center — Foot and Ankle Pain (Condition Page)
...
export const seo: SEOMeta = {
  title: "Foot and Ankle Pain Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Foot and Ankle Pain treatment in Arlington Heights, IL. Pain, swelling, or weakness in the foot or ankle from sprains, tendonitis, or arthritis. Call (224) 735-3522.",
  keywords: ["foot ankle pain treatment Arlington Heights", "foot ankle pain doctor near me", "foot and ankle pain specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/joints/foot-ankle-pain",
};

export const hero: HeroSection = {
  eyebrow: "Joints Conditions",
  headline: "Foot and Ankle Pain Treatment in Arlington Heights, IL",
  subheadline: "Pain, swelling, or weakness in the foot or ankle from sprains, tendonitis, or arthritis.",
...
export const definition = {
  headline: "What Is Foot and Ankle Pain?",
  body: "Pain, swelling, or weakness in the foot or ankle from sprains, tendonitis, or arthritis. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Pain with walking or standing" },
    { text: "Swelling around the ankle" },
    { text: "Instability or giving way" },
    { text: "Stiffness in the morning" },
    { text: "Bruising after injury" },
    { text: "Difficulty bearing weight" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    ...
    { text: "Arthritis" },
    { text: "Work injuries from standing or uneven surfaces" }
  ] as CauseItem[],
};
...
export const howWeHelp = {
  headline: "Foot and Ankle Pain Treatment at Rand Medical Center",
...
export const ctaSection = {
  headline: "Get Help for Foot and Ankle Pain in Arlington Heights",
  body: "Don't let foot and ankle pain hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

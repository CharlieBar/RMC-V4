// src/content/conditions/spine/radiculopathy.ts
// Rand Medical Center — Radiculopathy (Condition Page)
...
export const seo: SEOMeta = {
  title: "Radiculopathy Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Radiculopathy treatment in Arlington Heights, IL. Pain, numbness, or weakness caused by a pinched or irritated nerve as it exits the spine. Call (224) 735-3522.",
  keywords: ["radiculopathy treatment Arlington Heights", "radiculopathy doctor near me", "radiculopathy specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/spine/radiculopathy",
};

export const hero: HeroSection = {
  eyebrow: "Spine Conditions",
  headline: "Radiculopathy Treatment in Arlington Heights, IL",
  subheadline: "Pain, numbness, or weakness caused by a pinched or irritated nerve as it exits the spine.",
...
export const definition = {
  headline: "What Is Radiculopathy?",
  body: "Pain, numbness, or weakness caused by a pinched or irritated nerve as it exits the spine. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Pain radiating from the spine into an arm or leg along a specific nerve path" },
    { text: "Numbness or tingling in the affected limb" },
    { text: "Muscle weakness" },
    { text: "Decreased reflexes" },
    { text: "Burning or electric-shock sensation" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    { text: "Herniated disc compressing a nerve root" },
    { text: "Bone spurs from arthritis" },
    { text: "Spinal stenosis" },
    { text: "Degenerative disc changes" },
    { text: "Trauma or injury" }
  ] as CauseItem[],
};
...
export const howWeHelp = {
  headline: "Radiculopathy Treatment at Rand Medical Center",
...
export const treatmentOptions = {
  ...
  treatments: [
    ...
    { name: "Transforaminal Epidural Injections", slug: "transforaminal-epidural-injections", href: "/services/pain-management/transforaminal-epidural-injections" }
  ] as TreatmentLink[],
};
...
export const ctaSection = {
  headline: "Get Help for Radiculopathy in Arlington Heights",
  body: "Don't let radiculopathy hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

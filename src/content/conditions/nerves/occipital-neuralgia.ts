// src/content/conditions/nerves/occipital-neuralgia.ts
// Rand Medical Center — Occipital Neuralgia (Condition Page)
...
export const seo: SEOMeta = {
  title: "Occipital Neuralgia Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Occipital Neuralgia treatment in Arlington Heights, IL. Sharp, shooting pain at the base of the skull from irritation of the occipital nerves. Call (224) 735-3522.",
  keywords: ["occipital neuralgia treatment Arlington Heights", "occipital neuralgia doctor near me", "occipital neuralgia specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/nerves/occipital-neuralgia",
};

export const hero: HeroSection = {
  eyebrow: "Nerves Conditions",
  headline: "Occipital Neuralgia Treatment in Arlington Heights, IL",
  subheadline: "Sharp, shooting pain at the base of the skull from irritation of the occipital nerves.",
...
export const definition = {
  headline: "What Is Occipital Neuralgia?",
  body: "Sharp, shooting pain at the base of the skull from irritation of the occipital nerves. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Sharp, shooting pain from the base of the skull upward" },
    { text: "Pain behind the eyes" },
    { text: "Sensitivity to light" },
    { text: "Tenderness at the back of the head" },
    { text: "Pain triggered by neck movement" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    { text: "Tight neck muscles compressing the nerves" },
    { text: "Whiplash or neck injury" },
    { text: "Cervical arthritis" },
...
export const howWeHelp = {
  headline: "Occipital Neuralgia Treatment at Rand Medical Center",
...
export const ctaSection = {
  headline: "Get Help for Occipital Neuralgia in Arlington Heights",
  body: "Don't let occipital neuralgia hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

// src/content/conditions/nerves/diabetic-neuropathy.ts
// Rand Medical Center — Diabetic Neuropathy (Condition Page)
...
export const seo: SEOMeta = {
  title: "Diabetic Neuropathy Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Diabetic Neuropathy treatment in Arlington Heights, IL. Nerve damage from diabetes causing burning foot pain, numbness, and balance issues. Call (224) 735-3522.",
  keywords: ["diabetic neuropathy treatment Arlington Heights", "diabetic neuropathy doctor near me", "diabetic neuropathy specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/nerves/diabetic-neuropathy",
};

export const hero: HeroSection = {
  eyebrow: "Nerves Conditions",
  headline: "Diabetic Neuropathy Treatment in Arlington Heights, IL",
  subheadline: "Nerve damage from diabetes causing burning foot pain, numbness, and balance issues.",
...
export const definition = {
  headline: "What Is Diabetic Neuropathy?",
  body: "Nerve damage from diabetes causing burning foot pain, numbness, and balance issues. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Burning or tingling in the feet" },
    { text: "Loss of sensation in the feet and toes" },
    { text: "Sharp or shooting pains" },
    { text: "Balance problems and fall risk" },
    { text: "Muscle weakness" },
    { text: "Foot ulcers due to reduced sensation" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    { text: "Prolonged high blood sugar damaging small blood vessels that nourish nerves" },
    { text: "Duration and severity of diabetes" },
    { text: "Poor blood sugar control" },
...
export const howWeHelp = {
  headline: "Diabetic Neuropathy Treatment at Rand Medical Center",
...
export const ctaSection = {
  headline: "Get Help for Diabetic Neuropathy in Arlington Heights",
  body: "Don't let diabetic neuropathy hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

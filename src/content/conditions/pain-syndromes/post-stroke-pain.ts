// src/content/conditions/pain-syndromes/post-stroke-pain.ts
// Rand Medical Center — Post-Stroke Pain (Condition Page)
...
export const seo: SEOMeta = {
  title: "Post-Stroke Pain Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Post-Stroke Pain treatment in Arlington Heights, IL. Pain or abnormal sensations after a stroke due to nerve and brain changes. Call (224) 735-3522.",
  keywords: ["post stroke pain treatment Arlington Heights", "post stroke pain doctor near me", "post-stroke pain specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/pain-syndromes/post-stroke-pain",
};

export const hero: HeroSection = {
  eyebrow: "Pain Syndromes Conditions",
  headline: "Post-Stroke Pain Treatment in Arlington Heights, IL",
  subheadline: "Pain or abnormal sensations after a stroke due to nerve and brain changes.",
...
export const definition = {
  headline: "What Is Post-Stroke Pain?",
  body: "Pain or abnormal sensations after a stroke due to nerve and brain changes. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Burning or aching pain in the affected side" },
    { text: "Sensitivity to temperature or touch" },
    { text: "Muscle stiffness and spasticity" },
    { text: "Pain triggered by normal sensations" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    { text: "Damage to brain areas that process pain" },
    { text: "Central sensitization" },
    { text: "Muscle spasticity" },
    { text: "Nerve pathway disruption" }
  ] as CauseItem[],
};
...
export const howWeHelp = {
  headline: "Post-Stroke Pain Treatment at Rand Medical Center",
...
export const ctaSection = {
  headline: "Get Help for Post-Stroke Pain in Arlington Heights",
  body: "Don't let post-stroke pain hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

// src/content/conditions/pain-syndromes/pelvic-pain.ts
// Rand Medical Center — Pelvic Pain (Condition Page)
...
export const seo: SEOMeta = {
  title: "Pelvic Pain Treatment in Arlington Heights, IL | Rand Medical Center",
  description: "Pelvic Pain treatment in Arlington Heights, IL. Pain in the lower abdomen or pelvic region from musculoskeletal, nerve, or other causes. Call (224) 735-3522.",
  keywords: ["pelvic pain treatment Arlington Heights", "pelvic pain doctor near me", "pelvic pain specialist"],
  canonical: "https://www.randmedicalcenter.com/conditions/pain-syndromes/pelvic-pain",
};

export const hero: HeroSection = {
  eyebrow: "Pain Syndromes Conditions",
  headline: "Pelvic Pain Treatment in Arlington Heights, IL",
  subheadline: "Pain in the lower abdomen or pelvic region from musculoskeletal, nerve, or other causes.",
...
export const definition = {
  headline: "What Is Pelvic Pain?",
  body: "Pain in the lower abdomen or pelvic region from musculoskeletal, nerve, or other causes. At Rand Medical Center in Arlington Heights, IL, we evaluate this condition thoroughly and create a personalized treatment plan to help you feel and function better.",
};

export const symptoms = {
  headline: "Common Symptoms",
  items: [
    { text: "Pain in the lower abdomen or pelvis" },
    { text: "Pain with sitting" },
    { text: "Discomfort during certain activities" },
    { text: "Referred pain to the lower back or hips" }
  ] as SymptomItem[],
};
...
export const causes = {
  ...
  items: [
    { text: "Musculoskeletal imbalances" },
    { text: "Pelvic floor dysfunction" },
    { text: "SI joint problems" },
    { text: "Nerve irritation" },
    { text: "Post-surgical adhesions" }
  ] as CauseItem[],
};
...
export const howWeHelp = {
  headline: "Pelvic Pain Treatment at Rand Medical Center",
...
export const ctaSection = {
  headline: "Get Help for Pelvic Pain in Arlington Heights",
  body: "Don't let pelvic pain hold you back. Our team can evaluate your condition and build a treatment plan that works for you. Schedule an appointment or call today.",

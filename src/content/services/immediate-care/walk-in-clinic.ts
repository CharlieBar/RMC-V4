// src/content/services/immediate-care/walk-in-clinic.ts
// Rand Medical Center — Walk-In Injury & Illness Clinic (Service Detail)

import type { SEOMeta, HeroSection, FeatureItem, FAQItem } from "@/types/content";

export const seo: SEOMeta = {
  title: "Walk-In Injury & Illness Clinic in Arlington Heights, IL | Rand Medical Center",
  description: "Walk-in clinic in Arlington Heights, IL for urgent injuries and illnesses — no appointment needed. Same-day evaluation and treatment.",
  keywords: ["walk in clinic Arlington Heights", "walk-in injury & illness clinic near me"],
  canonical: "https://www.randmedicalcenter.com/services/immediate-care/walk-in-clinic",
};

export const hero: HeroSection = {
  eyebrow: "Immediate Care",
  headline: "Walk-In Injury & Illness Clinic in Arlington Heights, IL",
  subheadline: "no appointment needed. Same-day evaluation and treatment..",
...
export const overview = {
  headline: "About Walk-In Injury & Illness Clinic",
  body: "Our walk-in clinic provides same-day access for patients who need medical attention but don't have a life-threatening emergency. You can come in without an appointment during clinic hours for sudden injuries, acute pain episodes, minor illnesses, and urgent work-related incidents.\n\nOur clinic is staffed by physicians and advanced practice providers who can evaluate your condition, order on-site diagnostics, start treatment, and arrange follow-up care — all in one visit.",
};

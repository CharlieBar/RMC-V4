// src/content/services/diagnostic-surgical-services/same-day-procedures.ts
// Rand Medical Center — Same-Day Procedures (Service Detail)

import type { SEOMeta, HeroSection, FeatureItem, FAQItem } from "@/types/content";

export const seo: SEOMeta = {
  title: "Same-Day Procedures in Arlington Heights, IL | Rand Medical Center",
  description: "Same-day surgical and interventional procedures in Arlington Heights, IL — go home the same day with follow-up care coordinated.",
  keywords: ["same day procedures Arlington Heights", "same-day procedures near me"],
  canonical: "https://www.randmedicalcenter.com/services/diagnostic-surgical-services/same-day-procedures",
};

export const hero: HeroSection = {
  eyebrow: "Diagnostic & Surgical Services",
  headline: "Same-Day Procedures in Arlington Heights, IL",
  subheadline: "go home the same day with follow-up care coordinated..",
...
export const overview = {
  headline: "About Same-Day Procedures",
  body: "Same-day procedures allow you to receive surgical or interventional treatment and return home on the same day, avoiding the cost and inconvenience of an overnight hospital stay. Our outpatient surgery center is designed specifically for procedures that can be safely performed in this setting.\n\nBefore any procedure, our team provides pre-operative instructions, verifies insurance coverage, and ensures you understand what to expect. After the procedure, you recover in our monitored recovery area before being discharged with detailed home care instructions.",
};
